...
import 'package:mvvm_flutter_app/views/components/movie_list.dart';
...
class _MovieListPageState extends State<MovieListPage> {
  ...
  Widget build(BuildContext context) {
    final movieVM = Provider.of<MovieListViewModel>(context);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(children: <Widget>[
          ...
          Expanded(child: MovieList(movies: movieVM.movies))
        ]),
      ),
    );
  }
